...
Complete aesthetic constraints and rejection rules live in the Skill and production prompts. They preserve the original brief without turning its historical 3:4 canvas into a hidden default. [SKILL.md](SKILL.md) · [production prompt](references/xxd-panel-047-prompt.en.md)
...
| --- | --- | --- |
| `top-bottom` | user-confirmed whole canvas | one complete generation: high-fidelity source above, 047 design below, approximately 50/50 |
| `left-right` | user-confirmed whole canvas | one complete generation: high-fidelity source left, 047 design right, approximately 50/50 |
| `design-only` | user-confirmed whole canvas | 047 design fills the canvas; source remains invisible |
...
Project-specific copy rule: Use one concise subject, place, emotion, or symbolic title plus only necessary subtitle, supplied number, or micro-note. Align native type with isometric direction, impasto edge, perspective route, or warm-white field; it must echo the space rather than float as a separate headline.
...
Full specifications: [Skill workflow](SKILL.md) · [source archive](references/047-source.md) · [English prompt](references/xxd-panel-047-prompt.en.md) · [Chinese prompt](references/xxd-panel-047-prompt.zh-CN.md)
...
<div align="center"><strong>The subject does not sit on paint; it enters a world that paint has made.</strong></div>
